...
// import {useNumberFormatter} from "@filipve/vue-lib-starter/src";
// import { PersonalButton, PersonalInput, Formatters } from "@filipve/test-component2";
...
// })
// const { formattedNumber } = Formatters.useNumberFormatter(number, language, options)
...
<template>
  ...
  <div class="prose text-xl dark:prose-light">
    ...
    <p>
      This is my personal take on a Vite + Vue 3 template. If you want to try
      it:
    </p>
    ...
    <ul>
      ...
      <li>
        <a target="_blank" href="https://router.vuejs.org/">Vue Router</a> to
        handle routes;
      </li>
      <li>
        <a target="_blank" href="https://pinia.vuejs.org/">Pinia</a> for state
        management;
      </li>
      <li>
        <a target="_blank" href="https://vueuse.org/">Vueuse</a> for useful
    ...
    <ul>
      ...
      <li>
        <a target="_blank" href="https://www.cypress.io/">Cypress</a> for e2e
        testing;
      </li>
    </ul>
    ...
    <p>
      TypeScript cannot handle type information for <code>.vue</code> imports by
      default, so we replace the <code>tsc</code> CLI with
      <code>vue-tsc</code> for type checking. In editors, we need
      <a
          target="_blank"
          href="https://marketplace.visualstudio.com/items?itemName=Vue.vscode-typescript-vue-plugin"
      >TypeScript Vue Plugin (Volar)</a>
    ...
    <ol>
      <li>
        ...
        <ol>
          <li>
            Run <code>Extensions: Show Built-in Extensions</code> from
            VSCode&#39;s command palette
          </li>
          <li>
            Find <code>TypeScript and JavaScript Language Features</code>, right
            click and select <code>Disable (Workspace)</code>
          </li>
        </ol>
      </li>
      <li>
    ...
    <p>
      This runs the end-to-end tests against the Vite development server. It is
      much faster than the production build.
    </p>
    <p>
      But it&#39;s still recommended to test the production build with
      <code>test:e2e</code> before deploying (e.g. in CI environments):
    </p>
    <pre><code>pnpm run build
pnpm run test:e2e
</code></pre>
    <h3 id="lint-fix-and-format-with-eslint-and-antfueslint-config-settings">
      Lint, fix and format with
      <a target="_blank" href="https://eslint.org/">ESLint</a> and
